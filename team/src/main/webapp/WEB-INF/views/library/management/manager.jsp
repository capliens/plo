...
.updateBook-btn {
	border: 2px solid #83c67a; border-radius: 5px;
	box-sizing: border-box; margin-bottom: 10px;
}

.updateBook-btn:hover {
	color: #fff; background-color: #cae39a;
	font-weight: bold;
}

.deleteBook-btn {
	border: 2px solid #e18393; border-radius: 5px;
	box-sizing: border-box;
}

.deleteBook-btn:hover {
	color: #fff; background-color: #e594a1;
	font-weight: bold;
}
...
.search-box {
	...
	border-top: 0px solid; background-color: #fff;
	width:calc(100% - 210px); top: 38px;
	left: 150px; box-sizing: border-box;
	...
	<div class="container ">
		...
		<div class="search input-group  mt-5">
			<select class="form-control" name="type" id="type">
				...
				<option value="boCode">도서 코드</option>
			</select> 
		...
		$.ajax({
			...
			success : function (data){
				...
				if(data.bookList.length!=0){
					...
					str+=`<tr><td colspan="8">책이 없습니다.</td></tr>`;
				}
