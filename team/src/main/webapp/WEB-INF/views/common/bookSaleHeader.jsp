			...
			<c:if test="${user.me_mr_num >= 0}">
				<li class="nav-item dropdown"><a
					...
					<ul class="dropdown-menu">
						<li><a class="dropdown-item" href="<c:url value="/mypage"/>">내
								정보</a></li>
						<li><a class="dropdown-item"
							href="<c:url value="/mypage/post"/>">내가 쓴 게시글</a></li>
						<li><a class="dropdown-item"
							href="<c:url value="/mypage/comment"/>">내가 쓴 댓글</a></li>
						<li><a class="dropdown-item"
							href="<c:url value="/mypage/report"/>">내가 신고한 내역</a></li>
						<li><a class="dropdown-item"
							href="<c:url value="/library/order/list"/>">내 주문내역</a></li>
						<li><a class="dropdown-item"
							href="<c:url value="/mypage/loan"/>">내가 대출한 도서</a></li>
						<li><a class="dropdown-item"
							href="<c:url value="/mypage/reserve"/>">내가 예약한 도서</a></li>
					</ul></li>
			</c:if>
			<c:if test="${user.me_mr_num == 0}">
				<li class="nav-item"><a class="nav-link"
					href="<c:url value="/grade/list"/>">등급 관리</a></li>
			</c:if>
			<c:if test="${user != null}">
				<li class="nav-item"><a class="nav-link"
